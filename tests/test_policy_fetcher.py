...
class TestGetPolicyFromAws:
    ...
    @patch('boto3.client')
    def test_get_policy_from_aws_by_name(self, mock_boto3_client, sample_policy_document, sample_get_policy_response, sample_get_policy_version_response):
    ...
    @patch('boto3.client')
    def test_get_policy_from_aws_by_arn(self, mock_boto3_client, sample_policy_document, sample_get_policy_response, sample_get_policy_version_response):
    ...
    @patch('boto3.client')
    def test_get_policy_from_aws_customer_managed_fallback(self, mock_boto3_client, sample_policy_document, sample_get_policy_response, sample_get_policy_version_response, sample_get_caller_identity_response):
...
class TestGetPoliciesFromRole:
    ...
    def test_get_policies_from_role_success(self, mock_get_policy, mock_boto3_client, sample_policy_document, sample_get_role_response, sample_list_attached_role_policies_response, sample_list_role_policies_response, sample_get_role_policy_response, sample_get_caller_identity_response, sample_get_policy_response, sample_get_policy_version_response):
...
class TestGetPoliciesFromUser:
    ...
    @patch('boto3.client')
    @patch('policy_fetcher.get_policy_from_aws')
    def test_get_policies_from_user_success(self, mock_get_policy, mock_boto3_client, sample_policy_document, sample_get_user_response, sample_list_attached_user_policies_response, sample_list_user_policies_response, sample_get_user_policy_response, sample_get_caller_identity_response, sample_get_policy_response, sample_get_policy_version_response):
