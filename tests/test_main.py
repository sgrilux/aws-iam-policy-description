...
class TestMainIntegration:
    ...
    def test_main_file_input_success(self, mock_setup_logging, mock_get_policy, mock_get_descriptions, mock_output, sample_policy_document, sample_processed_permissions):
        ...
        mock_output.assert_called_once_with(sample_processed_permissions, 'table', None)

    @patch('main.output_results')
    @patch('main.get_action_descriptions')
    @patch('main.get_policy_from_aws')
    @patch('main.setup_logging')
    def test_main_name_input_success(self, mock_setup_logging, mock_get_policy, mock_get_descriptions, mock_output, sample_policy_document, sample_processed_permissions):
    ...
    @patch('main.get_policy_from_aws')
    @patch('main.setup_logging')
    def test_main_policy_arn_input_success(self, mock_setup_logging, mock_get_policy, mock_get_descriptions, mock_output, sample_policy_document, sample_processed_permissions):
    ...
    @patch('main.output_results')
    @patch('main.process_multiple_policies')
    @patch('main.get_policies_from_role')
    @patch('main.setup_logging')
    @patch('main.get_default_cache_dir')
    def test_main_role_input_success(self, mock_cache_dir, mock_setup_logging, mock_get_policies, mock_process, mock_output, sample_policy_document, sample_processed_permissions):
        ...
        mock_process.return_value = sample_processed_permissions
        ...
        mock_process.assert_called_once_with(mock_policies, True, '/test/cache/dir', True)
        mock_output.assert_called_once_with(sample_processed_permissions, 'table', None)
    ...
    @patch('main.setup_logging')
    def test_main_user_input_success(self, mock_setup_logging, mock_get_policies, mock_process, mock_output, sample_policy_document, sample_processed_permissions):
    ...
    @patch('main.get_policy_from_file')
    @patch('main.setup_logging')
    def test_main_json_output_format(self, mock_setup_logging, mock_get_policy, mock_get_descriptions, mock_output, sample_policy_document, sample_processed_permissions):
        ...
        mock_output.assert_called_once_with(sample_processed_permissions, 'json', None)

    @patch('main.output_results')
    @patch('main.get_action_descriptions')
    @patch('main.get_policy_from_file')
    @patch('main.setup_logging')
    def test_main_output_to_file(self, mock_setup_logging, mock_get_policy, mock_get_descriptions, mock_output, sample_policy_document, sample_processed_permissions):
        ...
        mock_output.assert_called_once_with(sample_processed_permissions, 'table', 'output.json')

    @patch('main.output_results')
    @patch('main.get_action_descriptions')
    @patch('main.get_policy_from_file')
    @patch('main.setup_logging')
    def test_main_verbose_logging(self, mock_setup_logging, mock_get_policy, mock_get_descriptions, mock_output, sample_policy_document, sample_processed_permissions):
    ...
    @patch('main.get_policy_from_file')
    @patch('main.setup_logging')
    def test_main_no_cache_option(self, mock_setup_logging, mock_get_policy, mock_get_descriptions, mock_output, sample_policy_document, sample_processed_permissions):
    ...
    @patch('main.get_policy_from_file')
    @patch('main.setup_logging')
    def test_main_ssl_verify_disabled(self, mock_setup_logging, mock_get_policy, mock_get_descriptions, mock_output, sample_policy_document, sample_processed_permissions):
    ...
    @patch('main.get_policy_from_file')
    @patch('main.setup_logging')
    def test_main_custom_cache_dir(self, mock_setup_logging, mock_get_policy, mock_get_descriptions, mock_output, mock_default_cache, sample_policy_document, sample_processed_permissions):
