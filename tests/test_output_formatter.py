        ...
        permissions_with_principals = [
            {
                ...
                "PolicyMetadata": {"PolicyName": "TestPolicy", "PolicyType": "Trust"},
                "actions": {"sts:AssumeRole": "Grants permission to assume a role"},
            }
        ]
...
class TestFormatOutputJson:
    ...
    def test_format_output_json_special_characters(self):
        ...
        test_data = [{"test": 'value with "quotes" and \\ backslashes', "unicode": "🔐 test"}]
...
class TestFormatOutputCsv:
    ...
    def test_format_output_csv_basic(self, sample_processed_permissions):
        ...
        assert result.startswith(
            "Statement,PolicyName,PolicyType,Sid,Action,Description,Effect,Resource,Principal,Condition"
        )
        ...
        permissions_with_principals = [
            {
                ...
                "Resource": ["*"],
                "Condition": {},
                "Principal": {"Service": ["ec2.amazonaws.com"], "AWS": "arn:aws:iam::123456789012:user/testuser"},
                "PolicyMetadata": {"PolicyName": "TestPolicy", "PolicyType": "Trust"},
                "actions": {"sts:AssumeRole": "Grants permission to assume a role"},
            }
        ]
        ...
        special_permissions = [
            {
                ...
                "Condition": {},
                "Principal": {},
                "PolicyMetadata": {"PolicyName": "Test\nPolicy", "PolicyType": "Managed"},
                "actions": {"s3:GetObject": 'Description with, commas and "quotes"'},
            }
        ]
        ...
        special_permissions = [
            {
                ...
                "Condition": {},
                "Principal": {},
                "PolicyMetadata": {"PolicyName": "Test&Policy", "PolicyType": "Managed"},
                "actions": {"s3:GetObject": "Description with <tags> & ampersands"},
            }
        ]
